...
/**
 * Created by ClownMonkey on 2016/12/28.
 */
...
//    private Integer _category;
    ...
    @ExcelResources(title="种类",order=6)
    ...
    public WebShopDto(Integer shopid, String shopname, String des, String userName, String userphne, String category, String picture, Integer price, String shop_status, String put_time ) {
        this.shopid = shopid;
        this.shopname = shopname;
        this.des = des;
        this.userName = userName;
